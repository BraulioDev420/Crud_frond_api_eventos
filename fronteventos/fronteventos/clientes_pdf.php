...
class PDF extends PDF_Tabla
{
   ...
   function Header()
   {
      $this->SetTitulo('Listado de Frutas');
      $this->cabecera();
      //Salto de linea
      $this->Ln(3);
   ...
   function Tabla()
   {
      ...
      $cabecera = array('No', 'Nombre', 'Apellido', 'Direccion ', 'Telefono ', 'Correo');
      $this->SetWidths(array(10, 20, 20, 35, 30, 60)); // define el ancho de la columnas
      $this->SetFont('Arial', 'B', 10);
