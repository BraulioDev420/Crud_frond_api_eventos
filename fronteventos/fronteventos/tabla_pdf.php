...
var $aligns;
var $titulo;
//Funcion Que imprime el Encabezado  de p�gina
function cabecera()
{
    ...
    $this->MultiCell(0,5,'SISTEMA DE GESTION DE MIL HEROTICOS',0,'C');
     //Movernos a la derecha
    $this->Cell(30);
    //--------------Nit--------------------
...
function piepagina()
{
    ...
    //--------------Enumera las paginas parte ineferior-----------------
       $this->Text(15,$y+3,"GESTION DE EVENTOS    Fecha:  ".date("d/m/Y"));
